...
Previously, we saw a tool that allowed us to have a conversation with JavaScript.
This tool is known as a REPL, short for [Read Evaluate Print Loop][repl]. Code written
in the top box will be read and evaluated. The response, whatever is returned, will
appear in the bottom box. For example, below we have a REPL with a math equation, 
`10 + 10`, prewritten inside. If you click the "Play" button above the equation, you should see
...
Clicking on the equation will let you edit it to whatever you like. When you click the "Play"
button again, the changes will be read and you'll see the response in the bottom box.
...
with REPLs so far. Think about `255 / 5`.  Which parts of the
